      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-gold/20 border border-gold/30 rounded-full px-5 py-2 mb-8"
          >
            <span className="w-2 h-2 bg-gold rounded-full animate-pulse" />
            <span className="text-gold font-medium text-sm">ADMISSIONS OPEN 2026–2027</span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="font-serif text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-cream leading-tight mb-6"
          >
            India's Premier
          ...
          <motion.p
            ...
            className="text-cream/80 text-lg md:text-xl max-w-2xl mx-auto mb-8"
          >
